...
abstract class ActivityUtils {
    ...
    public static Activiteit createActiviteit(Activity activity) {
        ...
        String description = getDescription(activity);
        String manual = getManual(activity);
        Set<Property> properties = new HashSet<Property>();
        addProperties(activity, properties);
    ...
    public static Activiteit updateActiviteit(Activity activity, Activiteit oldActiviteit) {
        String newName = getName(activity);
        if (newName.isEmpty()) {
            Toast.makeText(activity, R.string.toast_edit_nameless, Toast.LENGTH_SHORT).show();
            return null;
        }
        String newDescription = getDescription(activity);
        String newManual = getManual(activity);
        Set<Property> newProperties = new HashSet<Property>();
        addProperties(activity, newProperties);
        // Create activiteit
    ...
    public static void updateGUI(Activity a, Activiteit activiteit) {
        setName(a, activiteit.getName());
        setDescription(a, activiteit.getDescription());
        setManual(a, activiteit.getManual());
        setProperties(a, activiteit.getProperties().values());
    }
